            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="../demande_crud/create.php" aria-expanded="false">
                                <span>
                                    <i class="ti ti-article"></i>
                                </span>
                                <span class="hide-menu">Depot</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="../demande_crud/index.php" aria-expanded="false">
                                ...
                                <span class="hide-menu">en cours</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            ...
                            <a class="sidebar-link" href="../participant_crud/index.php" aria-expanded="false">
                                ...
                                <span class="hide-menu">refuses</span>
                            </a>
                        </li>
                        <li class="nav-small-cap">
                            <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
