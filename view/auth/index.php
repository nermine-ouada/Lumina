...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-sm-8 col-7">
                    <ul class="info">
                        <li><a href="#"><i class="fa fa-envelope"></i>lumina@gmail.com</a></li>
                        <li><a href="#"><i class="fa fa-phone"></i>+216 ** *** ***</a></li>
                    </ul>
                </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright © 2024 Lumina Co., Ltd. All Rights Reserved.
                        <br>Github: <a href="https://github.com/nermine-ouada/Lumina" target="_parent"
                            title="free css templates">Click here</a>
                    </p>
                </div>
            </div>
        </div>
