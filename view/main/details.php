        ...
        <section class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo ($row['session_title']); ?></h5>
                            <p class="card-text">Formation Title:
                                <?php echo ($row['formation_title']); ?>
                            </p>
                            <p class="card-text">Formateur: <?php echo ($row['formateur_name']); ?></p>
                            <p class="card-text">Promotion Title:
