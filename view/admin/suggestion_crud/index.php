...
<div class="container-fluid">
    <div class="row">
                ...
                <div class="card-body p-4">
                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                        <div class="mb-3 mb-sm-0">
                            <h5 class="card-title fw-semibold">Suggestion Table</h5>
                        </div>
                        ...
                        <div>
                            <?php if (!isset($_GET["show_all"])) { ?>
                                <form action="index.php" method="GET">
                                    ...
                                    <button type="submit" class="btn btn-danger m-3">Show all</button>
                                </form>
        ...
        join formateur on  formation_suggestion.formateur_id=formateur.formateur_id where formation_suggestion.etat="encours"';
